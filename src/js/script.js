...
const botaoScaner = document.getElementById("btn-texto");
...
async function configurarCamera(){
    ...
    try{
        ...
        const midia= await navigator.mediaDevices.getDisplayMedia({
...
botaoScanear.onclick =async ()=>{
    ...
    resultado.innerText="Fazendo a leitutra do texto...aguarde";
    ...
    try{
        ...
        resultado.innerText=textoFinal.lenght > 0 ?
        textoFinal: "Não foi possível identificar o texto";
